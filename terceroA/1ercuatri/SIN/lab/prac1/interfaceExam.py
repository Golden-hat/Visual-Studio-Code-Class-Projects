...
class InterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.algorithmbox.configure(cursor="hand2", state="readonly",
                                    values=('BFS', 'DFS (Graph Search)', 'DFS (Backtracking)', 'Voraz (Manhattan)', 'ID', 'A* Manhattan', 'A* Euclidean', 'IDA* Manhattan', 'A* Misplaced', 'A* Sequence', 'A* Columns'))
    ...
    def solveState():
        ...
        if str(algorithm) == 'BFS':
            ...
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Misplaced':
            main.graphSearch(initialState,main.function_1,main.misplacedTiles)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Sequence':
            main.graphSearch(initialState,main.function_1,main.sequences)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
        elif str(algorithm) == 'A* Columns':
            main.graphSearch(initialState,main.function_1,main.columns)
            path, cost, counter, depth, runtime, nodes, max_stored, memory_rep = \
                main.graphf_path, main.graphf_cost, main.graphf_counter, main.graphf_depth, main.time_graphf, main.node_counter, main.max_counter, main.max_rev_counter
