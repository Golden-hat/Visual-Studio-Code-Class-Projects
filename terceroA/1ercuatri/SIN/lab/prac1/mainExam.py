...
def misplacedTiles(state):
    cost = 0
    for i in range(0,8):
        if state[i] != end_state[i] and end_state[i] != 0:
            cost += 1
...
def columns(state):
    ...
    for i in range(1,9):
        ...
        if itemX == goalX: sum += 1
        if itemY == goalY: sum += 1
...
def sequences(state):
    totalCost = 0
    for i in range(0,8):
        if state[i] == 0 and i != 4:
            totalCost += 2
        elif state[i] != 0 and i == 4:
            totalCost += 1
        else:
            if i == 0:
                if int(state[0]) + 1 != int(state[1]) % 8:
                    totalCost += 2
            if i == 1:
                if int(state[1]) + 1 != int(state[2]) % 8:
                    totalCost += 2
            if i == 2:
                if int(state[2]) + 1 != int(state[5]) % 8:
                    totalCost += 2
            if i == 3:
                if int(state[3]) + 1 != int(state[0]) % 8:
                    totalCost += 2
            if i == 5:
                if int(state[5]) + 1 != int(state[8]) % 8:
                    totalCost += 2
            if i == 6:
                if int(state[6]) + 1 != int(state[3]) % 8:
                    totalCost += 2
            if i == 7:
                if int(state[7]) + 1 != int(state[6]) % 8:
                    totalCost += 2
            if i == 8:
                if int(state[8])+ 1 != int(state[7]) % 8:
                    totalCost += 2
