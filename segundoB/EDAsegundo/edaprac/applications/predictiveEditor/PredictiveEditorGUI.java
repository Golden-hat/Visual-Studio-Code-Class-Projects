 ...
 */
public class PredictiveEditorGUI extends JFrame implements
    ...
    private static final String DICCIONARIO_POR_DEFECTO = "applications"
        + File.separator + "predictiveEditor"
        + File.separator + "castellano.txt";
    private static final String ANYADIR_PALABRA = "Add a word?";
    private static final int MAX_SUCESORES = 20;
    
    // Atributos para el Editor Predictivo
    private String palabraActual;
    private PredictiveEditor editor;
     ...
     */
    private PredictiveEditorGUI() {
        super("PREDICTIVE EDITOR");
        editor = new PredictiveEditor(DICCIONARIO_POR_DEFECTO);
        palabraActual = "";
        setUndecorated(true);
    ...
    private void inicializarInterfaz() {
        ...
        // Etiqueta de titulo
        lblTitle = new JLabel("EDA SMARTPHONE");
        lblTitle.setFont(new Font("arial", Font.BOLD + Font.ITALIC, 20));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setBounds(110, 20, 190, 19);
        ...
        btnLoad = new JButton("load dictionary");
        ...
        btnSave = new JButton("save dictionary");
    ...
    public void seleccionarSugerencia() {
        ...
        String sel = listSucesores.getSelectedValue();
        if (sel.equals(ANYADIR_PALABRA)) {
            if (JOptionPane.showConfirmDialog(this,
                 String.format("Do you want to add '%s' to the dictionary?", palabraActual),
                "Confirmation",
                 JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                editor.include(palabraActual);
                try {
            ...
            if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                if (!ext.equalsIgnoreCase("txt")) {
                    JOptionPane.showMessageDialog(this, 
                        "You must pick a text file: *.txt",
                        "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    editor = new PredictiveEditor(fichero.toString());
                    JOptionPane.showMessageDialog(this, 
                        "New dictionary loaded", "Information",
            ...
            if (fileChooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) {
                ...
                if (!ext.equalsIgnoreCase("txt")) {
                    JOptionPane.showMessageDialog(this, 
                        "You must pick a text file: *.txt",
                        "Error", JOptionPane.ERROR_MESSAGE);
                } else if (filename.equalsIgnoreCase("castellano.txt")) {
                    JOptionPane.showMessageDialog(this, 
                        "Can't override the standard dictionary: castellano.txt", "Error",
                        JOptionPane.ERROR_MESSAGE);
                } else {
                    editor.save(fichero.toString());
                    JOptionPane.showMessageDialog(this, 
                        "New dictionary saved", "Information",
                        JOptionPane.INFORMATION_MESSAGE);
                }
            }
     ...
     */    
    private static class JButtonRound extends JButton {
        private int posY;
...
//                         }
                ...
                if (s.length() > 0) {
                    ...
                    DefaultListModel<String> dlm = (DefaultListModel<String>) listSucesores.getModel();
                    dlm.clear();
                    ...
                    if (c == ' ' || c == ',' || c == '.') { 
                        ...
                        palabraActual += c;
                        ListPOI<String> suc =
                            editor.successors(palabraActual,
                                MAX_SUCESORES - 1);
                        for (suc.begin(); !suc.isEnd(); suc.next()) {
                            dlm.addElement(suc.get());
                        }
